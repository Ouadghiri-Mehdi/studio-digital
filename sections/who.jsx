      ...
      <div className="container">
        ...
        <div className="founders">
          <FounderCard
            ...
            photoStyle={{ objectPosition: "center 70%", transform: "scale(1.8)", transformOrigin: "center 50%" }}
          />
          <FounderCard
            idx={2}
            ...
            photoStyle={{ objectPosition: "center 75%", transform: "scale(2.6)", transformOrigin: "center 55%" }}
          />
        </div>
